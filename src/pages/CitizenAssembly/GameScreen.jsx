...
import news9 from "../../assets/news/news15.jpg";
import news10 from "../../assets/news/news14.jpg";
    ...
    <div className="h-full flex">
      ...
      <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
        ...
        {newsToShow && selectedOption && (
          <NewsModal
            news={newsToShow}
            breakingNews={"Citizens’ Assembly launches • Transparency praised • Parliament to respond soon!"}
            onClose={() => {
              next(
